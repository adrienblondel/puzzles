if (kiosk_category == 1)
{
    title_to_display = ob_language_controller.kiosk_categories_7;
    pack_sprite_index = sp_kiosk_category_icon_cursor;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 5;
}
else if (kiosk_category == 2)
{
    title_to_display = ob_language_controller.kiosk_categories_6;
    pack_sprite_index = sp_kiosk_category_icon_music;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 6;
}
else if (kiosk_category == 3)
{
    title_to_display = ob_language_controller.kiosk_categories_2;
    pack_sprite_index = sp_kiosk_category_icon_experimentals;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 11;
}
else if (kiosk_category == 4)
{
    title_to_display = ob_language_controller.kiosk_categories_5;
    pack_sprite_index = sp_kiosk_category_icon_themes;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 8;
}
else if (kiosk_category == 5)
{
    title_to_display = ob_language_controller.kiosk_categories_3;
    pack_sprite_index = sp_kiosk_category_icon_figurals;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 7;
}
else if (kiosk_category == 6)
{
    title_to_display = ob_language_controller.kiosk_categories_9;
    pack_sprite_index = sp_kiosk_category_icon_toolbar_backings;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 8;
}
else if (kiosk_category == 7)
{
    title_to_display = ob_language_controller.kiosk_categories_8;
    pack_sprite_index = sp_kiosk_category_icon_avatars_backings;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 5;
}
else if (kiosk_category == 8)
{
    title_to_display = ob_language_controller.kiosk_categories_4;
    pack_sprite_index = sp_kiosk_category_icon_challenges;
    colour_set_to_use = choose(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19);
    total_frames = 8;
}
else if (kiosk_category == 9)
{
    title_to_display = ob_language_controller.kiosk_categories_1;
